...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  - RD's are the actual code of the datasets while SQL is a language to go through and manipulate the data, but not actual code.
- [ ] Why do tables need a `primary key`?
  - The PK is needed to be a unique identifier for each table and dataset in order to effectively use the code.
